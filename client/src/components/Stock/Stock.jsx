    ...
    <>
      <section className="py-5" >
        <div className="2xl:container mx-auto ">
          <div className="w-[90%] mx-auto grid grid-cols-1 md:grid-cols-4 bg-black h-[100vh]">
            {stockData.map((e) => {
              return (
                <Link to={`/stocks/${e.stock_id}`} key={e.stock_id}>
                  <div className="shadow-2xl drop-shadow-md max-w-[200px] max-h-[500px] rounded-lg overflow-hidden bg-white hover:slide-fwd-center justify-center items-center">
